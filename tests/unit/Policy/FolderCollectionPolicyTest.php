...
/**
 * Unit tests for FolderCollectionPolicy.
 */
final class FolderCollectionPolicyTest extends TestCase {
	private PermissionService $permissionService;
	private FolderCollectionPolicy $policy;

	protected function setUp(): void {
		parent::setUp();

		$this->permissionService = $this->createMock(PermissionService::class);
		$this->policy = new FolderCollectionPolicy($this->permissionService);
	}
