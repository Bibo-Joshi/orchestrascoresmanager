...
/**
 * Unit tests for ScoreBookPolicy.
 */
final class ScoreBookPolicyTest extends TestCase {
	private PermissionService $permissionService;
	private ScoreBookPolicy $policy;

	protected function setUp(): void {
		parent::setUp();

		$this->permissionService = $this->createMock(PermissionService::class);
		$this->policy = new ScoreBookPolicy($this->permissionService);
	}
